export const buttonShortcuts: Record<string, string> = {
  ...
  'o-button': 'text-context border rounded shadow-sm px-1em py-0.25em inline-flex justify-center items-center gap-1 op80 !outline-none',
  'o-button-base': 'bg-context border-context c-white',
  'o-button-hover': 'op100 !border-context text-white bg-context',
